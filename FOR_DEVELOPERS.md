...
| ---- | ---- | ---- |
|`master`|`production`|本番サイト https://nagasaki.stopcovid19.jp/|
|`staging`|`gh-pages`|ステージングサイト https://stage-covid19-nagasaki.netlify.com/|
|`development`|`dev-pages`|開発用サイト https://nagasaki-dev.stopcovid19.jp/|
...
| ---- | ---- | ---- | ---- | ---- |
| 開発 | development | https://nagasaki-dev.stopcovid19.jp/ | 全開発者 | base branch。基本は、この`development`ブランチに Pull Requestを送ってください。 |
| ステージング | staging | https://stage-covid19-nagasaki.netlify.com/ | 管理者のみ | 本番前の最終確認用。管理者以外の Pull Request は禁止です。 |
| 本番 | master | https://nagasaki.stopcovid19.jp/ | 管理者のみ | 管理者以外の Pull Request は禁止です。 |

### 5-2. システムで利用しているブランチ

| 目的 | ブランチ | 確認URL | 備考 |
| ---- | -------- | ---- | ---- |
| 本番サイトHTML | production | https://nagasaki-dev.stopcovid19.jp/ | 静的ビルドされたHTMLが置いてある場所 |
| ステージングサイト HTML | gh-pages | https://stage-covid19-nagasaki.netlify.com/ | 静的ビルドされたHTMLが置いてある場所 |
