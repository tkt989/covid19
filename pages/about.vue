<template>
  <div class="About">
    ...
    <TextCard>
      当サイトは新型コロナウイルス感染症（COVID-19）に関する最新情報を提供するために、Code
      for 長崎が開設したものです。<br />
      <br />
      Code for 長崎による公式情報と客観的な数値をわかりやすく伝えることで、Code
      for 長崎にお住まいの方や、Code for 長崎内に拠点を持つ企業の方、Code for
      長崎を訪れる方が、現状を把握して適切な対策を取れるようにすることを目的としています。
    </TextCard>
    ...
    <TextCard title="免責事項">
      当サイトに掲載されている情報の正確性については万全を期していますが、Code
      for
      長崎は利用者が当サイトの情報を用いて行う一切の行為について責任を負うものではありません。<br />
      <br />
