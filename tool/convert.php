...
{
  $data = xlsxToArray(__DIR__.'/downloads/Code for 長崎患者発生発表数-RAW.xlsx', 'RAW', 'A2:J100', 'A1:J1');
  ...
  return [
    'date' => xlsxToArray(__DIR__.'/downloads/Code for 長崎患者発生発表数-RAW.xlsx', 'RAW', 'M1')[0][0],
    'data' => [
