...
Illustration by [まつもとりょうた](http://pinografi.com) [Twitter](https://twitter.com/pinografico) under [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/deed.ja)
...
| 目的 | ブランチ | 確認URL | 備考 |
| ---- | -------- | ---- | ---- |
| 開発 | development | https://dev-covid19-nagasaki.netlify.com | base branch。基本はこちらに Pull Requestを送ってください |
| 緊急適用用 | dev-hotfix | なし | 急ぎ本番に適用するべき修正。管理者から依頼された場合こちらを使ってください |
| ステージング | staging | https://stg-covid19-nagasaki.netlify.com/ | 本番前の最終確認用。管理者以外の Pull Request は禁止です |
| 本番 | master | https://nagasaki.stopcovid19.jp/ | 管理者以外の Pull Request は禁止です |

#### システムで利用しているブランチ
| 目的 | ブランチ | 確認URL | 備考 |
| ---- | -------- | ---- | ---- |
| 本番サイトHTML | production | https://nagasaki.stopcovid19.jp/ | 静的ビルドされたHTMLが置いてある場所 |
| ステージングサイト HTML | gh-pages | https://stg-covid19-nagasaki.netlify.com/ | 静的ビルドされたHTMLが置いてある場所 |
